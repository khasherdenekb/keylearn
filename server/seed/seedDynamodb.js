...
const user_course_progress_model_1 = __importDefault(require("../models/user-course-progress.model"));
...
function createTables() {
    return __awaiter(this, void 0, void 0, function* () {
        const models = [transaction_model_1.default, user_course_progress_model_1.default, course_model_1.default];
